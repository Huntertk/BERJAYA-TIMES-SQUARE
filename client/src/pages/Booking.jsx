    ...
    return (
        <section className='bookingMainContainer'>
            <div className="bookingWrapper">
                <img className='banner' src={"https://res.cloudinary.com/drrkaak40/image/upload/v1706714289/Malaysia%20Experience/BERJAYA%20TIMES%20SQUARE/dizzy_izzy_xnmpgu.jpg"} alt="" />
